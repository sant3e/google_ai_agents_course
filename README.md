...
This repository contains my personal implementations and notes from the 5-Day AI Agents Intensive Course developed by Google's ML researchers and engineers.
...
- **Day 1**: Introduction to AI Agents fundamentals
  - `Day1a.ipynb` - First part of Day 1 exercises
  - `Day1b.ipynb` - Second part of Day 1 exercises
...
These notebooks represent my personal learning journey through the course material, adapted with my own implementations and approaches to the exercises and examples provided.